...
?>
<div class="<?php echo $this_convention; ?>">
    <div class="hotel <?php echo get_field( 'sold_out' ) ? 'sold-out' : ''; ?>">
        ...
        <div class="accommodation-content-outer-wrapper">
            ...
            <?php if ( get_field( 'hotel_URL' ) && ! get_field( 'sold_out' ) ) { ?><a class="accommodation-button-text button" target="_blank" href="<?php the_field( 'hotel_URL' ); ?>">BOOK ONLINE NOW</a><?php } ?>
        </div>
    </div>
</div>
