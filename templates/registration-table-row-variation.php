<tr id="post-<?php echo $variation_array['variation_id']; ?>" <?php ghc_product_post_class( $variation_array['variation_id'] ); ?>>
    ...
    <td class="actions">
        ...
        if ( $registration_product ) {
            echo '<input class="qty" name="qty-' . $variation_array['variation_id']  . '" type="hidden" value="1" min="1" max="1" disabled title="Only one of these products is allowed per order." />
