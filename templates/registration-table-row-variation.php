<tr id="post-<?php echo $variation_array['variation_id']; ?>" <?php ghc_product_post_class( $variation_array['variation_id'] ); ?>>
    ...
    <td class="actions">
        ...
        if ( $registration_product ) {
            ...
            $addon = new Product_Addon_Display();
            echo $addon->display();
        } else {
        ...
        <p class="product woocommerce add_to_cart_inline">
            <a rel="nofollow" href="<?php echo $variation->add_to_cart_url() ?>" data-quantity="1" data-product_id="<?php echo $variation_array['variation_id']; ?>" class="button product_type_variation add_to_cart_button ajax_add_to_cart">Add to my order</a>
        </p>
    </td>
</tr>
