<div class="three columns">
    <div class="gdlr-item gdlr-speaker-item">
        <div class="gdlr-ux gdlr-speaker-item-ux">
            <div class="gdlr-speaker-thumbnail"><?php the_post_thumbnail( 'small-grid-size' ) ?><a class="gdlr-speaker-thumbnail-overlay-link" href="<?php the_permalink(); ?>"><span class="gdlr-speaker-thumbnail-overlay"></span></a></div>
